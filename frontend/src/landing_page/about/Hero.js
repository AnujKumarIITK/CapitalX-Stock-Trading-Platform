...
function Hero() {
    return ( 
        <div className="container">
            ...
            <div className="row p-5 mt-5 mb-5 border-top text-muted" style={{ lineHeight: "1.8", fontSize: "1.1rem" }}>
                ...
                <div className="col-5 p-4">
                    ...
                    <p>
                        And yet, we are always up to something new every day. Catch up on the latest updates on our <a href="" target="_blank" rel="noopener noreferrer" style={{textDecoration: "none"}}>blog</a> or see what the media is <a href="" target="_blank" rel="noopener noreferrer" style={{textDecoration: "none"}}>saying about us</a> or learn more about our business and product <a href="" target="_blank" rel="noopener noreferrer" style={{textDecoration: "none"}}>philosophies</a>.
                    </p>
                </div>
